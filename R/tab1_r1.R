#' tab1_r1 function
#'
#' This function create table1 in biostatistics for repeated measures, v1: count n(id)
...
tab1_r1 <- function(DATA, ID, TIME, FUNC = "mean", CONDIGITS = 1, CATDIGITS = 1, TYPE = 1){
